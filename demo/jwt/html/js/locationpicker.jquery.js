...
(function($) {
    ...
    var GmUtility = {
        ...
        updateLocationName: function(gmapContext, callback) {
            gmapContext.geodecoder.geocode({
                ...
                if (status == google.maps.GeocoderStatus.OK && results.length > 0) {
                    ...
                    gmapContext.addressComponents = GmUtility.address_component_from_google_geocode(address.address_components, address.formatted_address );
        ...
        address_component_from_google_geocode: function(address_components, formatted_address) {
            var result = {};
